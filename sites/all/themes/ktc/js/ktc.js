(function ($) {
	...
	$(document).ready(function() {
		...
		Cufon.replace('body.node-type-soda-story-form-page div.field-name-field-story-rules div.field-item h3');
		Cufon.replace('body.node-type-soda-story-form-page div.field-name-field-story-rules div.field-item ul li');
		Cufon.replace('body.node-type-soda-story-form-page div.field-name-field-story-rules div.field-item p');
